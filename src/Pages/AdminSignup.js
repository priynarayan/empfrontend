...
export default function AdminSignup() {
  ...
  const handleSubmit = (e) => {
    ...
    Axios.post("https://localhost:7055/api/Users/RegisterAdmin", {
      firstName: fname,
      lastName: lname,
      emailId: email,
      password: pass,
    ...
    <MDBContainer fluid>
      ...
      <MDBCard className='mx-2 mb-5 p-5 shadow-5' style={{ marginTop: '-100px', background: 'hsla(0, 0%, 100%, 0.8)', backdropFilter: 'blur(30px)' }}>
        <MDBCardBody className='p-3 text-center'>
          ...
          <h2 className="fw-bold mb-5">Admin Register</h2>
          <form id="form" onSubmit={handleSubmit} >
            <MDBRow>
              <MDBCol col='6'>
                <MDBInput wrapperClass='mb-4' id='form1' label='Last name' type='text' name='First_name' value={fname} onChange={(e) => setFname(e.target.value)} />
              </MDBCol>
              <MDBCol col='6'>
          ...
          <p className='footas'>By clicking Sign up, you agree to our Terms.
            <br></br> Learn how we collect, use and share data
            <br></br> in our Data Policy and how we use cookies.</p>

          <MDBBtn className='w-20 mb-4' size='md' type='submit' form="form">Sign Up</MDBBtn>
